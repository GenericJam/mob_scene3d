defmodule S3dSpike.App do
  @moduledoc "Application entry point for S3dSpike."

  use Mob.App

  @impl Mob.App
  def navigation(_platform) do
    stack(:main, root: S3dSpike.HomeScreen)
  end
  ...
  def on_start do
    ...
    Ecto.Migrator.with_repo(S3dSpike.Repo, fn repo ->
      Ecto.Migrator.run(repo, migrations_dir(), :up, all: true)
    end)

    Mob.Screen.start_root(S3dSpike.HomeScreen)
    Mob.Dist.ensure_started(node: :"s3d_spike_android@127.0.0.1", cookie: :mob_secret)
  end
  ...
  defp migrations_dir do
    case System.get_env("MOB_BEAMS_DIR") do
      nil -> Application.app_dir(:s3d_spike, "priv/repo/migrations")
